            ...
            <tbody>
                <tr>
                    ...
                    <tr class="row${status.count % 2}">
                                            <td class="salary_total_time"><fmt:formatDate value='${salary.year_month}' pattern='yyyy-mm' /></td>
                                            <td class="salary_days">${salary.days }</td>
                        <td class="salary_salary"><fmt:formatNumber value='${salary.salary}' pattern='###,###' /></td>
                                                                    <td class="salary_total_time">${salary.total_time }</td>
                                                <td class="salary_salary"><c:out value="${salary.wage }"/></td>
